    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">                
                ...
                <input type="text" name="inputMSSV" class="form-control" value="<?php echo $row['mssv']; ?>" readonly>
                </div>
                ...
                <div class="form-group">
                <label for="inputMaLop">Lớp danh nghĩa: </label>
                <input type="text" name="inputMaLop" class="form-control" value="<?php echo $row['malop']; ?>" readonly>
                </div>
